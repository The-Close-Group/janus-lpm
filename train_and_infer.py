#!/usr/bin/env python3
"""
Train a medium size model and perform inference with it.
"""
import json
import os
import pandas as pd
...
def main():
    ...
    # 4. Train the model
    model, metrics, synth_data = train_model(synth_data, size="medium", epochs=15, batch_size=128)
